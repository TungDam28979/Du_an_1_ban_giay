...
public class ProductDAO {
    ...
    public List<TenGiay> getTop5SP(int trang) {
    ...
    //Thực hiện truy vấn top 5 sản phẩm dựa theo số trang và ngày tạo giảm dần
    public List<TenGiay> getTop5SPTheoTrangThai(String trangThai, int trang) {
    ...
    public List<TenGiay> selectTop5_SP_TheoTimeUpdate_GiamDan(String trangThai, int trang) {
    ...
    public TenGiay getCreate_Update_By_ID_tenSP(int idSP) {
        try {
...
//                pd.setId(rs.getInt("ID"));
    ...
    public int updateTest(TenGiay e) {
        return JDBCHelper.update(UPDATE_SP_BY_ID,
                e.getName(),
                e.getStatus(),
                e.getUpdate_By(),
    ...
    public List<TenGiay> selectAll() {
        return selectBySQL(SELECT_ALL_SP_BY_SQL);
    }

    //Truy vấn tên SP với ngày tạo giảm dần
    public List<TenGiay> select_TenSP_Create_at_GiamDan() {
        return selectBySQL(SELECT_TENSP_GIAMDAN_CreateAt_SPCT);
    }

    //Truy vấn tên SP với SL giảm dần
    public List<TenGiay> select_TenSP_SL_GiamDan() {
        return selectBySQL(SELECT_TENSP_GIAMDAN_SL_SPCT);
    }

    public TenGiay selectById(String id) {
        List<TenGiay> listTG = selectBySQL(SELECT_SP_BY_ID, id);
        if (!listTG.isEmpty()) {
            return listTG.get(0);
        }
        return null;
    ...
    public List<TenGiay> select_TenSP_CoTrangThai_DungKinhDoanh_BY_SQL() {
    ...
    public List<TenGiay> select_TenSP_CoTrangThai_DangKinhDoanh_BY_SQL() {
        return selectBySQL(SELECT_SP_TrangThai_DangKinhDoanh__BY_SQL);
    }

    public List<TenGiay> selectBySQL(String sql, Object... args) {
        List<TenGiay> listProd = new ArrayList<>();
        try {
